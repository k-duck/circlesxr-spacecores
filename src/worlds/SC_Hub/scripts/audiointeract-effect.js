...
AFRAME.registerComponent('audiointeract-effect', {
  schema: {
  ...
  init: function() {
    ...
    Context_AF.audio = new Audio("/worlds/SC_Hub/assets/audio/Interact.wav");
    ...
    Context_AF.el.addEventListener('hitstart', function() {
      ...
      Context_AF.robot.setAttribute("position"," -14.009, 1.585, -3.228");
      Context_AF.robot.setAttribute("rotation"," 0, 45, 0");
