...
AFRAME.registerComponent('audiomercury-effect', {
  schema: {
  ...
  init: function() {
    ...
    Context_AF.audio = new Audio("/worlds/SC_Hub/assets/audio/Mercury.wav");
    ...
    Context_AF.el.addEventListener('hitstart', function() {
      ...
      Context_AF.robot.setAttribute("position"," -8, 1.585, 0");
      Context_AF.robot.setAttribute("rotation"," 0, 90, 0");
